...
const Layout = ({ children }) => {
    ...
    // Legacy Admin (Superadmin) has `role: 'admin'` property (string).
    // Employees have `roles` (array) and `permissions` (array).
    ...
    const allMenuItems = [
        { path: '/dashboard', label: 'Dashboard', icon: Icons.Dashboard, permission: 'dashboard' },
        {
            path: '/buses', label: 'Bus Management', permission: 'bus_management', icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
            )
        },
        {
            path: '/fleet', label: 'Fleet & Passengers', permission: 'fleet_passengers', icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
            )
        },
        { path: '/routes', label: 'Route Management', permission: 'route_management', icon: Icons.Route },
        {
            path: '/transport-requests',
            label: 'Requests',
            permission: 'transport_requests',
            icon: (
        ...
        {
            path: '/transport-dues',
            label: 'Transport Dues',
            permission: 'transport_dues',
            icon: (
